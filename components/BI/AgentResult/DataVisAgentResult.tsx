...
export function DataVisAgentResult({
  ...
  const { chartJsx, data, query, title: chartTitle } = chartData;
  ...
  const handleSave = useCallback(async () => {
    try {
      ...
      console.log("saving chart with title:", chartTitle);
      await saveChart(chartData, userData.user.id, chartTitle, chartId);
      setIsSaved(true);
